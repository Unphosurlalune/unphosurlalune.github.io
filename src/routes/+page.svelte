...
<p>
	Vous trouverez ici un peu de tout mais surtout du nous... L'idée c'est d'être authentique, sincère
	et de partager. C'est pourquoi nous avons créé ce blog.
</p>
<br />
...
<p>
	Des flux RSS à utiliser, à écouter ! C'est par là >>> <CategoryTiles url="/rss" text="flux rss" />
</p>
